...
<AccordionGroup>
  ...
  <Accordion title="Integration-friendly">
    We appreciate the essence of adaptability. That's why integrating our API with your existing setup is a breeze. You can use our simple API call and You also can use Neosantara APIs through [Openai](/quickstart)
  </Accordion>
