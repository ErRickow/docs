...
description: '> Learn how using Neosantara Code Interpreter'
---
...
- [**@e2b/code-interpreter**](https://npmjs.com/package/@e2b/code-interpreter)

# Example

<Note>
Before you begin please make a new file named `index.ts` or other name with following `.ts`
</Note>
...
- It has the following columns (examples included):
    ...
    - Region: "Jakarta", "Kuala Lumpur"
    - Surface area (km2): for example, 2780400
    - Population in thousands (2017): for example, 100271
