...
<Card icon="key" href="https://neosantara.xyz/dashboard/api-keys" title="Get your free API key" horizontal>
  You get 1,500 free Token Credits every day & 7,500 Token Credits every month. **No credit card required.**
</Card>
...
Visit your [Dashboard](https://neosantara.xyz/dashboard) or [Pricing Page](https://neosantara.xyz/pricing) to explore our plan options and manage your subscription.
