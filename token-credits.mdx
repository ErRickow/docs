...
| **Basic**                        | 150,000                | 13,000               | Rp 49.000          | Rp 227
| **Standard**                    | 300,000               | 20,0000              | Rp 199,000          | Rp 330
| **Pro**                      | 1,500,00               | 100,000              | Rp 399          | Rp 256
| **Enterprise**                   | Custom               | Custom             | Custom            |

Visit your [Dashboard](https://neosantara.xyz/dashboard) or [Pricing Page](https://neosantara.xyz/dashboard/pricing) to explore our plan options and manage your subscription.
...
The most accurate way to track the Token cost of each request, especially for advanced features and multimodal inputs, is through the `tokens_used field in the API response's _metadata` section or by checking your [Usage Dashboard](https://neosantara.xyz/dashboard/usage)