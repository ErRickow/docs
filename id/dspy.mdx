...
Setup dan hubungkan DSPy ke LLM di Neosantara AI
...
def search_wikipedia(query: str):
    ...
    # Untuk pencarian umum, Kamu mungkin menggunakan tools atau API yang berbeda
    # Untuk kasus spesifik ini, kita tetap menggunakan URL yang disediakan tetapi menyederhanakan outputnya
