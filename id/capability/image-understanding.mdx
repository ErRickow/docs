...
*   **[Vision di Responses API](/id/sdk/responses-api/image-input)**: Menggunakan tipe part `image` di API modern.
*   **[Vision di OpenAI Compatible API](/id/sdk/openai-compat/chat-completions#lampiran-gambar)**: Implementasi standar `image_url` untuk SDK OpenAI.
*   **[Vision di Anthropic Compatible API](/id/sdk/anthropic-compat/file-attachments)**: Menggunakan format blok gambar dari Anthropic.
