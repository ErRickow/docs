...
*   **Penyimpanan Permanen**: Jika kamu ingin gambar tetap ada di beberapa sesi (misal: untuk Batch API), gunakan [API File](/id/files-overview) untuk mengunggah dan mendapatkan `file_id`.
