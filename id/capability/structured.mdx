...
| **Unggulan Neosantara** | `archipelago-core-70b`, `garda-core`, `garda-agentic-mini`, `sea-lion-v4-27b-it` |
| **Llama & Khusus** | `llama-3.3-nemotron-super-49b-v1.5`, `llama-3.3-70b-instruct`, `llama-3.2-11b`, `qwen3-32b`, `grok-4.1-fast-non-reasoning`, `grok-code-fast`, `granite-3-8b-instruct`, `holo2-30b`, `hermes-2-pro-mistral-7b` |
