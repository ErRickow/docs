...
*   **[Data Terstruktur di Responses API](/id/sdk/responses-api/index)**: Direkomendasikan untuk penegakan skema yang kompleks.
*   **[Mode JSON di OpenAI Compatible](/id/sdk/openai-compat/structured-outputs)**: Mode JSON standar menggunakan SDK OpenAI.
*   **[Tool Calling di Anthropic Compatible](/id/sdk/anthropic-compat/tool-calls)**: Mengekstrak data terstruktur melalui definisi tool dalam format Anthropic.
