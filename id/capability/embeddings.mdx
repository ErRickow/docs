...
Saat Anda mengirim teks ke endpoint embeddings, model AI memproses teks dan mengeluarkan daftar angka floating-point (vektor). Teks dengan makna serupa akan memiliki vektor yang secara numerik "lebih dekat" satu sama lain dalam ruang dimensi tinggi.

API NeosantaraAI menyediakan endpoint `/v1/embeddings`.

## Penggunaan

Kirim permintaan POST ke endpoint `/v1/embeddings` dengan input teks Anda.
