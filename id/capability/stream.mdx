...
*   **[Streaming via Responses API](/id/sdk/responses-api/streaming)**: Direkomendasikan untuk proyek baru.
*   **[Streaming via OpenAI Compatible API](/id/sdk/openai-compat/chat-completions#streaming-chat-completion)**: Untuk pengguna SDK OpenAI.
*   **[Streaming via Anthropic Compatible API](/id/sdk/anthropic-compat/messages#streaming-messages)**: Untuk pengguna SDK Anthropic.
