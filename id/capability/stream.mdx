...
Streaming memungkinkan Kamu menerima sebagian respons dari API saat sedang dibuat, daripada menunggu seluruh respons selesai. Ini dapat meningkatkan persepsi latensi dan pengalaman pengguna secara signifikan, terutama untuk hasil yang panjang.

## Cara Kerja Streaming

Neosantara API mengimplementasikan streaming menggunakan **Server-Sent Events (SSE)** ketika Kamu mengatur parameter `stream: true` dalam permintaan Kamu. Saat permintaan streaming dibuat:
