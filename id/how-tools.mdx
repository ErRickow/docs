...
description: "> Panduan untuk mengintegrasikan dan memanfaatkan tools dengan model NeosantaraAI untuk kemampuan yang ditingkatkan."
---
...
Kamu dapat memaksa NeosantaraAI untuk menggunakan tools tertentu dengan parameter `tool_choice`.
...
Kamu dapat menggunakan tools untuk menginstruksikan NeosantaraAI menghasilkan output JSON yang mengikuti skema tertentu, bahkan jika Kamu tidak berniat mengeksekusi output tersebut.
...
2. **Prompt Lemah**: Gunakan bahasa yang lebih kuat dalam promptmu, misal: "Harap gunakan panggilan tools paralel untuk mendapatkan cuaca Jakarta dan Bandung secara bersamaan."
