...
Kami menyederhanakan integrasi, autentikasi, dan penagihan ke dalam satu API yang konsisten. Kamu bisa fokus membangun aplikasi, sementara kami menangani kompleksitas integrasi modelnya.
...
[Daftar](https://app.neosantara.xyz/signup) untuk mendapatkan API Key. Pengguna baru mendapatkan **kredit gratis di awal** dan **refill kredit bulanan**. Cek [Dashboard](https://app.neosantara.xyz/dashboard) untuk detail promo saat ini.

<Card icon="key" href="https://app.neosantara.xyz/api-keys" title="Dapatkan API Key Gratis" horizontal>
  Kredit awal gratis & refill bulanan. Tanpa kartu kredit.
</Card>
