...
<Note>
  Ingin tutorial langkah demi langkah untuk memulai dalam waktu kurang dari 5 menit? Kunjungi [Panduan Cepat](/id/api-reference/quickstart#panggilan-api-pertama) dan mulai coding!
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Ramah Integrasi">
    Kami menghargai esensi adaptabilitas. Itulah mengapa mengintegrasikan API kami dengan pengaturan Anda yang ada sangat mudah. Anda dapat menggunakan panggilan API sederhana kami dan juga menggunakan API Neosantara melalui [OpenAI SDK](/id/api-reference/quickstart).
  </Accordion>
...
Untuk memulai dengan API Neosantara, kunjungi [Panduan Cepat](/id/api-reference/quickstart) dan ikuti langkah-langkahnya.
