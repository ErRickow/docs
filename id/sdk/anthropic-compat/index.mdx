...
description: "Neosantara AI Gateway menyediakan endpoint API yang kompatibel dengan Anthropic, memungkinkan Kamu menggunakan SDK Anthropic resmi dan alat seperti Claude Code."
---
...
1.  ### Konfigurasi variabel lingkungan
    ...
    Konfigurasikan Claude Code untuk menggunakan AI Gateway Neosantara dengan menetapkan [variabel lingkungan](https://code.claude.com/docs/en/settings#environment-variables) berikut:
    ...
    ```bash
    alias claude-nai='ANTHROPIC_BASE_URL="https://api.neosantara.xyz/anthropic" ANTHROPIC_AUTH_TOKEN="kunci-api-neosantara" ANTHROPIC_API_KEY="" claude'
    ```
    ...
    ANTHROPIC_BASE_URL="https://api.neosantara.xyz/anthropic" \
    ANTHROPIC_AUTH_TOKEN="kunci-api-neosantara" \
    ANTHROPIC_API_KEY="" \
    claude "$@"
    ```
...
Arahkan klien Kamu ke URL dasar AI Gateway Neosantara dan gunakan [kunci API Kamu](/id/authentication) untuk autentikasi.
