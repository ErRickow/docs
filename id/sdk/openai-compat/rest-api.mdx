...
Jika Kamu lebih suka menggunakan API Neosantara AI Gateway secara langsung tanpa library klien OpenAI, Kamu dapat membuat permintaan HTTP menggunakan klien HTTP standar apa pun.
