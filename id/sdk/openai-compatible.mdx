...
description: "Gunakan SDK OpenAI resmi untuk berinteraksi dengan Neosantara."
---

Neosantara mendukung SDK OpenAI resmi. Kami menawarkan dua gaya API yang berbeda untuk berinteraksi dengan model kami. Pilih yang paling sesuai dengan arsitektur aplikasi Kamu.
