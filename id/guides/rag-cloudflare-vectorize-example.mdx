...
6. Menggunakan model obrolan Neosantara (`garda-core`) untuk menghasilkan jawaban yang berdasar menggunakan konteks yang diambil.
...
CHAT_MODEL = "garda-core" # Atau "garda-agentic-mini" untuk konteks yang lebih besar
