...
description: "Bangun aplikasi RAG menggunakan Neosantara dan ChromaDB."
---

Panduan ini menunjukkan cara membangun aplikasi Retrieval-Augmented Generation (RAG) menggunakan Neosantara untuk embedding dan LLM, serta [ChromaDB](https://www.trychroma.com/) sebagai basis data vektor.

## Tinjauan

Kamu akan mempelajari cara:

1. Setup klien Neosantara API.
