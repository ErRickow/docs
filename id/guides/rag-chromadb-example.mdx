...
client = OpenAI(
    ...
    api_key=os.getenv("NAI_API_KEY", "YOUR_API_KEY_HERE")
)
...
```python
documents = [
    "Sistem kontrol iklim Googlecar memungkinkan Anda mengatur suhu dan aliran udara menggunakan kenop di konsol tengah.",
