...
Since this is a custom endpoint, you access it using the SDK's generic request methods (or custom extensions if available).
...
# Response includes an 'id' you can use for the next turn!
```
