...
The Responses API simplifies tool use. You can define tools and let the model call them. The output structure cleanly separates tool calls.
...
| **State Management** | ✅ Supported | Managed via `store: true` and `previous_response_id` |
...
This uses the standard OpenAI format for defining tools and handling function call responses.
...
| **Tool Use** | ✅ Supported | Standard function calling format |
