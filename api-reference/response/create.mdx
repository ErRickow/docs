...
description: '> Stateful conversation API that implements the OpenAI Responses API specification.'
...
<ParamField path="model" type="string" required>
  Model identifier (see [`/v1/models`](/api-reference/list-available-models).
</ParamField>
