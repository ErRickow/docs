...
[Sign up](https://app.neosantara.xyz/signup) for Neosantara AI to get your API Key. You receive **10,000 free API Tokens every day and 30,000 free API Tokens every month**. No credit card required.

<Card icon="key" href="https://neosantara.xyz/api-keys" title="Get your free API key" horizontal>
