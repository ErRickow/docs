...
See the [Tool use with NeosantaraAI overview](/en/tools-overview) for a full working example of JSON output for image description.
...
<AccordionGroup>
  ...
  <Accordion title="Example of Tool Result with Error">
    ...
    NeosantaraAI will then interpret this content and incorporate it into its response to the user, e.g., "I'm sorry, I was unable to retrieve the current weather because the weather service API is not available. Please try again later."
  </Accordion>
</AccordionGroup>
