...
*   **[Responses API Structured Data](/en/sdk/responses-api/index)**: Recommended for complex schema enforcement.
*   **[OpenAI Compatible JSON Mode](/en/sdk/openai-compat/structured-outputs)**: Standard JSON mode using the OpenAI SDK.
*   **[Anthropic Compatible Tool Calling](/en/sdk/anthropic-compat/tool-calls)**: Extracting structured data via tool definitions in the Anthropic format.
