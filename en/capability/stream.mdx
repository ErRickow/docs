...
*   **[Responses API Streaming](/en/sdk/responses-api/streaming)**: Recommended for new projects.
*   **[OpenAI Compatible Streaming](/en/sdk/openai-compat/chat-completions#streaming-chat-completion)**: For OpenAI SDK users.
*   **[Anthropic Compatible Streaming](/en/sdk/anthropic-compat/messages#streaming-messages)**: For Anthropic SDK users.
