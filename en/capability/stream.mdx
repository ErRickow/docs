...
The [`/v1/responses`](/api-reference/responses/create) endpoint uses a modern, **event-driven stream**. Each chunk is a typed event, allowing you to easily handle different parts of the response, such as text deltas or function call arguments.
...
### Responses API Implementation Examples
...
### Chat Completions Implementation Examples
