---
title: "Reasoning"
description: "Solve complex tasks with step-by-step thinking using advanced reasoning models."
---

import { ModelCards } from '/snippets/model-cards.jsx';

Neosantara API supports various models designed for deep reasoning, mathematics, and complex problem-solving. These models can "think" before they answer, breaking down instructions into logical steps.
