...
When you use a model identified as a reasoning-capable model, Neosantara AI automatically appends a system-level instruction (e.g., *"Mohon jelaskan dengan pemikiran langkah demi langkah"*) to your request. This ensures the model breaks down the problem before giving you the final answer.
