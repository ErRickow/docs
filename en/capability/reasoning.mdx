...
*   **[Responses API Reasoning](/en/sdk/responses-api/text-generation#reasoning-models)**: How reasoning blocks appear in the stateful output array.
*   **[OpenAI Compatible Reasoning](/en/sdk/openai-compat/chat-completions)**: Using the `thinking` parameter with the OpenAI SDK.
*   **[Anthropic Compatible Reasoning](/en/sdk/anthropic-compat/messages)**: Using the native Anthropic `thinking` object.
