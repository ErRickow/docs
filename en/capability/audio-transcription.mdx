...
Neosantara provides a high-performance endpoint for transcribing audio files. Powered by models like **Whisper Large v3 Turbo**, OpenAI's fastest speech recognition model optimized for speed while maintaining high accuracy.
...
The Neosantara API provides the [`/v1/audio/transcriptions`](/api-reference/audio/transcription) endpoint for this purpose.
...
def transcribe_audio(file_path: str):
    """
    Transcribes an audio file using Neosantara.
    """
