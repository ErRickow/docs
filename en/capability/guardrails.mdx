...
Neosantara is fully compatible with [**openai-guardrails-js**](https://github.com/openai/openai-guardrails-js) and other similar client-side libraries. By combining these tools, you get **Double Guarding**: client-side validation for instant feedback and Neosantara's server-side Indonesian PII protection.
