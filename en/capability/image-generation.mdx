...
* **`neosantara-gen-2045`**: Our primary image generation model, hosted on Together AI. Recommended for quality and speed.
* **`replicate-stable-diffusion-xl`**: A Stable Diffusion XL model hosted on Replicate, serving as a robust fallback for image generation.
...
```json
{
  ...
  "data": [
    {
      "url": "[https://api.neosantara.xyz/share/generated/a1b2c3d4e5f67890a1b2c3d4e5f67890](https://api.neosantara.xyz/share/generated/a1b2c3d4e5f67890a1b2c3d4e5f67890)",
      "b64_json": null
    }
  ],
  "usage": {
