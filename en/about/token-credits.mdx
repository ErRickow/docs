...
- **What counts as a token?**
  Tokens are pieces of words used for processing text. On average, 1 token ≈ 4 characters or 0.75 words.

- **What is an SLA Guarantee?**
  For Pro and Custom plans (≥1 million tokens), we guarantee 99.9% API uptime and fast support response times. If we don’t meet these standards, you may receive token credits.

- **Can I top-up tokens anytime?**
  Yes, with the Custom plan, top-up tokens starting from Rp 9,999 (66,667 tokens). Changes take effect immediately.

- **What happens if I exceed my limits?**
  Requests will be temporarily limited. Top-up tokens or upgrade your plan to continue.

For more details, visit our [Pricing Page](https://app.neosantara.xyz/pricing) or contact our team via [Support](https://app.neosantara.xyz/contact).