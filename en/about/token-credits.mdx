...
- $Price = \left( \frac{Tokens}{1,000} \right) \times Rp\ 149.99$ (per 1,000 tokens).
- $Price = \left( \frac{Tokens}{1,000,000} \right) \times Rp\ 149,999$ (per 1 million tokens).
- Example: For 100,000 tokens:
  $$
  Price = 100,000 \times 0.15 = 15,000
  $$
  or
  $$
