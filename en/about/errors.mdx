---
title: "Errors"
description: "Understand how to handle errors and troubleshoot issues with the Neosantara API."
---

The Neosantara API uses standard HTTP status codes to indicate the success or failure of an API request. In general:
