...
<Steps>
  <Step title="Get your API Key">
    Sign up at the [Neosantara Dashboard](https://app.neosantara.xyz/dashboard) and generate your unique API key. You will receive **free initial credits** to get started.
  </Step>
