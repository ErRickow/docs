...
Agno is an open-source library for creating multimodal agents. It supports interactions with text, images, audio, and video while remaining model-agnostic, allowing you to use any model in the Neosantara library with our native integration.
...
Set your `NEOSANTARA_API_KEY` environment variable.
...
Below is a simple agent using the native Neosantara integration with access to web search.
