---
title: "Building your own RAG application using Neosantara and LlamaIndex"
...
Now we will provide some Neosantara introduction and ask "What is Neosantara?" with the retrieved information to llama-3.3-nemotron-super-49b-v1.5, which doesn't know what Neosantara is. We will use "nusa-embedding-0001" for embeddings.
...
def run_rag_completion(
    ...
    generative_model: str = "garda-core"
) -> str:
    """
    Run RAG completion using Neosantara and LlamaIndex.
