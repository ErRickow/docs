# Building your own RAG application using Neosantara AI and LlamaIndex

![image](/logo/llama-index.png)

> This guide will walk you through how to implement a RAG application using Neosantara + LlamaIndex.
