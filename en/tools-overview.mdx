---
title: 'Tool Use with NeosantaraAI'
description: '> Extend NeosantaraAI's capabilities by enabling it to interact with external tools and functions.'
---
...
<Note>
Steps 3 and 4 are optional. For some workflows, NeosantaraAI's tool use request (step 2) might be all you need, without sending results back to the model.
</Note>
