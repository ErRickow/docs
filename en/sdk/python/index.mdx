---
title: "Python"
description: "Use official OpenAI and Anthropic Python SDKs with Neosantara AI."
---

# Python

To get started with Python and Neosantara AI, you can either call the [OpenAI-Compatible](/en/sdk/openai-compat) or [Anthropic-Compatible](/en/sdk/anthropic-compat) API directly, or use the official [OpenAI](https://github.com/openai/openai-python) and [Anthropic](https://github.com/anthropics/anthropic-sdk-python) Python SDKs.
