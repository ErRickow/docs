...
Neosantara AI provides advanced configuration options through the OpenAI-compatible API, enabling you to control reasoning behavior and optimize performance for supported models.

## [Reasoning configuration](#reasoning-configuration)

Configure reasoning behavior for models that support extended thinking or chain-of-thought reasoning (e.g., **Kimi K2**, **Claude 3.7**). The `reasoning` parameter allows you to control how reasoning tokens are generated and returned.
