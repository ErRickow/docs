...
Generate images using AI models that support multimodal output through the OpenAI-compatible API. This feature allows you to create images alongside text responses using models like **Gemini 2.0 Flash**.
...
Point the OpenAI SDK to Neosantara AI and specify the modalities.
