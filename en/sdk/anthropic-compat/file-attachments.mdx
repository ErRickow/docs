...
const message = await anthropic.messages.create({
  model: 'nusantara-base', // Ensure model supports multimodal input
  max_tokens: 1024,
  messages: [
    {
      role: 'user',
...
<Info>
  **Model Compatibility**: Ensure you are using a multimodal model (like `nusantara-base`, `archipelago-70b`, or `kimi-k2`) when sending file attachments.
</Info>
