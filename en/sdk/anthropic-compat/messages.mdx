...
The Anthropic Compatible endpoint supports advanced features like the `thinking` parameter for models like `deepseek-r1` and `nusantara-base`.

For a complete guide on how Neosantara handles reasoning blocks and token reporting in the Anthropic format, see the **[Reasoning Capability](/en/capability/reasoning)** page.
