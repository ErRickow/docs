...
<Info>
  Sign up at [Neosantara](https://app.neosantara.xyz/api-keys) to receive **free initial credits**. No credit card required.
</Info>
...
# Model selection
MODEL_NAME = 'garda-core'  # Alternatives: 'archipelago-core-70b', 'Llama-3.3-Nemotron-Super-49B'
