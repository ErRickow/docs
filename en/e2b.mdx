...
<Card icon="key" href="https://app.neosantara.xyz/api-keys" title="Get Your Free Neosantara API Key" horizontal>
  Sign up at [Neosantara](https://app.neosantara.xyz/api-keys) to receive **10,000 free Token Credits** monthly. No credit card required.
</Card>
...
For further assistance, refer to the [E2B documentation](https://e2b.dev/docs) or [Neosantara support](https://www.neosantara.xyz/support).