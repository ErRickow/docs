---
title: "Quickstart: Using Vercel AI SDK With Neosantara"
description: "This guide will walk you through how to use Neosantara models with the Vercel AI SDK."
---

The Vercel AI SDK is a powerful Typescript library designed to help developers build AI-powered applications. Using Neosantara and the Vercel AI SDK, you can easily integrate AI into your TypeScript, React, or Next.js project. In this tutorial, we'll look into how easy it is to use Neosantara's models and the Vercel AI SDK.
...
2. Instantiate the Neosantara client and call the `generateText` function with garda-core to generate some text.
...
To stream from Neosantara models using the Vercel AI SDK, simply use `streamText` as seen below.
