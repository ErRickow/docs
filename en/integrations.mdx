---
title: "Integrations"
description: "Neosantara integrates with popular community AI frameworks and tools."
---

# Framework Integrations

The Neosantara [AI Gateway](/en/intro) integrates with popular community AI frameworks and tools, enabling you to build powerful AI applications while using the Gateway's features like [usage tracking](/en/about/billing-pricing) and [unified API access](/en/models-overview).

### [Integration overview](#integration-overview)

You can integrate the AI Gateway with popular frameworks in several ways:

*   **OpenAI Compatibility Layer**: Use the AI Gateway's [OpenAI-compatible endpoints](/en/sdk/openai-compat) to connect any framework that supports OpenAI.
*   **Native Support**: Direct integration through specific provider settings or official support.
*   **AI SDK Integration**: Leverage the [Vercel AI SDK](/en/using-neosantara-with-vercels-ai-sdk) to access [Neosantara](/en/intro) capabilities directly.

### [Supported frameworks](#supported-frameworks)

The following is a non-exhaustive list of frameworks that currently support Neosantara integration:

*   [LangChain](/en/langchain)
*   [LlamaIndex](/en/llama-index)
*   [Pydantic AI](/en/pydantic-ai)
*   [CrewAI](/en/crewai)
*   [DSPy](/en/dspy)
...
*LangChain is a framework for developing applications powered by large language models (LLMs). Swapping to Neosantara is as simple as changing the `base_url`.*
...
Learn more in our [LangChain Guide](/en/langchain).
...
Learn more in our [Neosantara - Vercel AI SDK Guide](/en/using-neosantara-with-vercels-ai-sdk).
...
Here's sample code to get you started with Llama Index + Neosantara:
...
Build PydanticAI agents using Neosantara models
...
Our guide demonstrates how to integrate Neosantara's language models with Arcade's tools to create an AI agent that can send emails.

Prerequisites:

* Neosantara API key - see here [https://app.neosantara.xyz/](https://app.neosantara.xyz/api-keys)
...
# Configure dspy with a LLM from Neosantara
...
Here's some sample code to get you started with Pinecone + Neosantara:
...
# Create an embedding on Neosantara
