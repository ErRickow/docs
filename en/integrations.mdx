---
title: "Integrations"
description: "Neosantara AI integrates with popular community AI frameworks and tools."
---
...
*   **AI SDK Integration**: Leverage the [Vercel AI SDK](/en/using-neosantara-with-vercels-ai-sdk) to access [Neosantara AI](/en/intro) capabilities directly.

### [Supported frameworks](#supported-frameworks)

The following is a non-exhaustive list of frameworks that currently support Neosantara AI integration:
...
*LangChain is a framework for developing applications powered by large language models (LLMs). Swapping to Neosantara AI is as simple as changing the `base_url`.*
