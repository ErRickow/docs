...
<CardGroup cols={2}>
  <Card title="Nusantara-Base" icon="trophy" href="#model-list">
    Our flagship model. Balanced performance for general tasks, optimized for Indonesian context.
    * **ID**: `nusantara-base`
    * **Context**: 64k
  </Card>

  <Card title="Garda-Beta-Mini" icon="bolt" href="#model-list">
...
Below is the complete list of available models on the Neosantara platform.
...
| `grok-code-fast` | **Coding**. xAI's latest coding model. | 256k | $0.20 / .50 (USD) |
| `claude-4.5-sonnet`| **Gateway**. Access Anthropic via Vercel. | 200k | $3.00 / 5.00 (USD) |
...
| `gemini-embedding-001` | **Embedding**. Gemini embedding model. | 2k | Free |
