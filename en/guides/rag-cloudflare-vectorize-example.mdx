...
description: "Build a RAG application using Neosantara and Cloudflare Vectorize"
---

This guide demonstrates how to build a scalable Retrieval-Augmented Generation (RAG) application leveraging **Cloudflare Vectorize** as your managed vector database, integrated with Neosantara for embeddings and large language model (LLM) calls.
...
1. Set up your Neosantara API client and Cloudflare API credentials.
...
CHAT_MODEL = "garda-core" # Or "garda-agentic-mini" for larger context
...
Finally, construct the prompt with the retrieved context and send it to a Neosantara chat model.
...
\n{context}\n---\n")
    ...
    # 3. Generate answer using Neosantara chat model
