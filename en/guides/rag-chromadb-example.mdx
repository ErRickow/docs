...
description: 'Build a full RAG application using Neosantara AI and ChromaDB'
---

This guide demonstrates how to build a complete Retrieval-Augmented Generation (RAG) application using Neosantara AI for embeddings and large language model (LLM) calls, integrated with [ChromaDB](https://www.trychroma.com/){:target="_blank"} as your vector database.
...
You'll need a Neosantara AI API Key. If you don't have one, get it from your [Neosantara Dashboard](https://app.neosantara.xyz/dashboard){:target="_blank"}.
...
def make_prompt(query, relevant_passage):
  # Escape single quotes and newlines in the passage for the prompt
  escaped_passage = relevant_passage.replace("'", "\'\'").replace("\n", " ")
