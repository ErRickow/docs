---
title: "DSPy"
description: "Using DSPy with Neosantara."
---
...
Setup and connect DSPy to LLMs on Neosantara
...
# Configure dspy with a LLM from Neosantara
lm = dspy.LM('openai/archipelago-core-70b',
             api_key=os.environ.get("NAI_API_KEY"),
             api_base="https://api.neosantara.xyz/v1")
...
<Accordion title="See output">
  The output will return a string for answer below:
